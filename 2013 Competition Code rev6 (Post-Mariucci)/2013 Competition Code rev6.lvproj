...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Sim Support Files" Type="Folder">
			<Item Name="FRC SimulatedRSC" Type="Folder">
				<Item Name="ive" Type="Folder">
					<Item Name="4in Perf Wheel.ive" Type="Document" URL="../2013 Competition Code rev1/FRC SimulatedRSC/ive/4in Perf Wheel.ive"/>
					<Item Name="AXIS M1011.ive" Type="Document" URL="../2013 Competition Code rev1/FRC SimulatedRSC/ive/AXIS M1011.ive"/>
					<Item Name="Devantech SRF05.ive" Type="Document" URL="../2013 Competition Code rev1/FRC SimulatedRSC/ive/Devantech SRF05.ive"/>
					<Item Name="FRC - Body.ive" Type="Document" URL="../2013 Competition Code rev1/FRC SimulatedRSC/ive/FRC - Body.ive"/>
					<Item Name="Honeywell HMC6343.ive" Type="Document" URL="../2013 Competition Code rev1/FRC SimulatedRSC/ive/Honeywell HMC6343.ive"/>
					<Item Name="Sparkfun Atomic IMU.ive" Type="Document" URL="../2013 Competition Code rev1/FRC SimulatedRSC/ive/Sparkfun Atomic IMU.ive"/>
				</Item>
			</Item>
			<Item Name="FRC Simulated.xml" Type="Document" URL="../2013 Competition Code rev1/FRC Simulated.xml"/>
		</Item>
		<Item Name="Robot Simulation Readme.html" Type="Document" URL="../2013 Competition Code rev1/Robot Simulation Readme.html"/>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="Update Outputs (Speed Controlled).vi" Type="VI" URL="../Update Outputs (Speed Controlled).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Gamepad Button Map.vi" Type="VI" URL="../Gamepad Button Map.vi"/>
			<Item Name="Right Joystick Button Map.vi" Type="VI" URL="../Right Joystick Button Map.vi"/>
			<Item Name="Left Joystick Button Map.vi" Type="VI" URL="../Left Joystick Button Map.vi"/>
			<Item Name="Toggle.vi" Type="VI" URL="../Toggle.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../Test.vi"/>
			<Item Name="Number To Boolean.vi" Type="VI" URL="../Number To Boolean.vi"/>
			<Item Name="Parse CSV From cRIO.vi" Type="VI" URL="../Parse CSV From cRIO.vi"/>
			<Item Name="Parse CSV From Disk.vi" Type="VI" URL="../Parse CSV From Disk.vi"/>
			<Item Name="Parse CSV (Polymorphic).vi" Type="VI" URL="../Parse CSV (Polymorphic).vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Autonomous Independent.vi"/>
			<Item Name="Bang-Bang Control.vi" Type="VI" URL="../Bang-Bang Control.vi"/>
			<Item Name="Auto-Shift.vi" Type="VI" URL="../../../2013 Testing Project/Auto-Shift.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../Periodic Tasks.vi"/>
			<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
			<Item Name="Automatic Shooter Sequence.vi" Type="VI" URL="../Automatic Shooter Sequence.vi"/>
			<Item Name="Once.vi" Type="VI" URL="../Once.vi"/>
			<Item Name="Dashboard Read-Write.vi" Type="VI" URL="../Dashboard Read-Write.vi"/>
			<Item Name="Parse Autonomous.vi" Type="VI" URL="../Parse Autonomous.vi"/>
			<Item Name="Get Loop Time.vi" Type="VI" URL="../Get Loop Time.vi"/>
			<Item Name="Begin (Trap II).vi" Type="VI" URL="../Begin (Trap II).vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../Robot Global Data.vi"/>
			<Item Name="Update Outputs.vi" Type="VI" URL="../Update Outputs.vi"/>
			<Item Name="Auto Release Frisbees.vi" Type="VI" URL="../Auto Release Frisbees.vi"/>
			<Item Name="Auto Steer (Polymorphic).vi" Type="VI" URL="../../2013 Competition Code rev4 (Pre-Mariucci)/Auto Steer (Polymorphic).vi"/>
			<Item Name="Auto Steer (Encoders).vi" Type="VI" URL="../../2013 Competition Code rev4 (Pre-Mariucci)/Auto Steer (Encoders).vi"/>
			<Item Name="Auto Steer (Gyro).vi" Type="VI" URL="../../2013 Competition Code rev4 (Pre-Mariucci)/Auto Steer (Gyro).vi"/>
			<Item Name="Left Joystick Button Map (n00b).vi" Type="VI" URL="../Left Joystick Button Map (n00b).vi"/>
			<Item Name="Right Joystick Button Map (n00b).vi" Type="VI" URL="../Right Joystick Button Map (n00b).vi"/>
			<Item Name="Gamepad Button Map (n00b).vi" Type="VI" URL="../Gamepad Button Map (n00b).vi"/>
	...
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		...
		<Property Name="alias.value" Type="Str">10.21.75.2</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="Support Code" Type="Folder">
			<Item Name="Button Maps" Type="Folder">
				<Item Name="Gamepad Button Map.vi" Type="VI" URL="../Gamepad Button Map.vi"/>
				<Item Name="Left Joystick Button Map.vi" Type="VI" URL="../Left Joystick Button Map.vi"/>
				<Item Name="Right Joystick Button Map.vi" Type="VI" URL="../Right Joystick Button Map.vi"/>
			</Item>
			<Item Name="Bang-Bang Control.vi" Type="VI" URL="../Bang-Bang Control.vi"/>
			<Item Name="Get Motor Stall Percentage.vi" Type="VI" URL="../Get Motor Stall Percentage.vi"/>
			...
			<Item Name="Parse Autonomous.vi" Type="VI" URL="../Parse Autonomous.vi"/>
			<Item Name="Once.vi" Type="VI" URL="../Once.vi"/>
			<Item Name="Get Encoder Rate (Engineering Units).vi" Type="VI" URL="../Get Encoder Rate (Engineering Units).vi"/>
			<Item Name="Get Loop Time.vi" Type="VI" URL="../Get Loop Time.vi"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="ArenPID.vi" Type="VI" URL="../ArenPID.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				<Item Name="Error Cluster From Error Code.vi" Type="VI" URL="/&lt;vilib&gt;/Utility/error.llb/Error Cluster From Error Code.vi"/>
				<Item Name="NetComm_CAN_Receive.vi" Type="VI" URL="/&lt;vilib&gt;/Rock Robotics/SystemInterfaces/NetworkCommunication/NetComm_CAN_Receive.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/Users/Peter/Desktop/builds</Property>
				<Property Name="RTExe_localDestPathType" Type="Str">&lt;none&gt;</Property>
				<Property Name="Source[0].itemID" Type="Str">{3EF667CC-4601-4261-B310-D774E506CD55}</Property>
